    ...
    <div class="container mx-auto">
        <section class="text-gray-600 body-font">
            <div class="container mx-auto flex px-5 py-24 md:flex-row flex-col items-center">
                <div class="lg:max-w-lg  lg:w-fullmd:w-1/2 w-5/6 mb-10 md:mb-0">
                    <h1 id="firstCountdownValue" class="mx-auto title-font mb-0"
                        style="font-size:250px;text-align:center;"></h1>
                    <h3 id="restCountdownValue" class="mx-auto font-medium text-3xl"
                        style="margin-top:-70px; text-align:center;" :></h3>
                    <h3 class="mx-auto font-medium text-md" style="text-align:center;" :>till next math-day</h3>
                </div>
                <div
                    class="lg:flex-grow md:w-1/2 lg:pl-24 md:pl-16 flex flex-col md:items-start md:text-left items-center text-center">
                    <h1 class="title-font sm:text-4xl text-3xl mb-0 font-medium text-gray-900">@if(date('Y-m-d',$nearest_day_timestamp) !== date('Y-m-d'))
                        The nearest math-day is at:
                        @else
                        Today is a math-day!
                        @endif
                        <br class="hidden lg:inline-block"><span class="text-gray-500">{{ date("l, jS \of F Y",
        ...
        <section class="text-gray-600 body-font">
            <div class="container px-20">
                ...
                <p>A <i>Math-day</i> is a day in which its short date format combines itself creating a perfect
                    mathematical condition.</p>
        ...
        <section class="text-gray-600 body-font">
            <div class="container px-20 pb-24 mx-auto flex flex-wrap">
                <h3 class="title-font sm:text-3xl text-2xl font-medium text-gray-900 mb-9 pt-24" id="forecast">Other
                    math days in the following year:</h3>
                ...
                <div class="flex relative pt-10 pb-20 sm:items-center md:w-2/3 mx-auto">
                    ...
                    <div class="flex-grow md:pl-8 pl-6 flex sm:items-center items-start flex-col sm:flex-row">
                        ...
                        <div class="flex-grow sm:pl-6 mt-6 sm:mt-0">
                            <h2 class="font-medium title-font text-gray-900 mb-1 text-xl">{{ date("d/m/y", $timestamp)
                                }}</h2>
